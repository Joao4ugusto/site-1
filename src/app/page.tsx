...
export default function Page() {
  ...
  return (
    ...
    <div className="  px-6 mt-28 md:px-36 lg:px-40 lg:mt-36 xl:px-[400px] 2xl:mt-40 2xl:px-[450px]">
      ...
      <p className=" text-color-font-secundaria  mb-10 font-medium text-sm  md:text-base leading-6">I m a UI developer based in Barcelona. I m interested in dev rel, design systems, web3, user/dev experience and under engineering.</p>
      <p className=" text-color-font-secundaria  mb-10 font-medium text-sm  md:text-base leading-6">I m currently working at Raycast as a DX Engineer to grow its developer community.</p>
