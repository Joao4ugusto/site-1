...
export default function Page() {
  ...
  return (
    <div className=" ">
    <div className=" px-6 py-28 md:px-36 lg:px-40 lg:py-36 xl:px-[400px] 2xl:py-40 2xl:px-[450px]">
      ...
      <p className=" dark:text-color-font-secundaria text-color-black/90  pb-10 font-normal text-base leading-6">Currently, I am committed to a continuous study of the principles of data structures and algorithms. If you re interested, you can follow along with my <a className=" underline underline-offset-4 hover:text-color-black/80 dark:hover:text-color-font-secundaria/60" href="https://github.com/Joao4ugusto/Data-Structure-and-Algorithm">repository</a>.</p>
      <p className=" dark:text-color-font-secundaria text-color-black/90 pb-14 font-normal text-base leading-6">Sometimes I write articles covering various topics in the field of technology on <a className=" underline underline-offset-4  hover:text-color-black/80 darkhover:text-color-font-secundaria/60" href="https://dev.to/joao31oliveira">dev.to</a>.</p>
    </div>
  </div>
  );
}
