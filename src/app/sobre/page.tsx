    ...
    <section className=" w-full h-full m-5 mt-32 md:mt-24 ">
      <div className="  md:ml-56 mf:ml-[235px] lg:ml-[450px] lg:w-[600px]">
            ...
            <div className=" flex gap-6">
              <a href="https://www.linkedin.com/in/jo%C3%A3o-augusto-oliveira-15b018238/" className=" hover:bg-color-fundo/80  cursor-pointer rounded text-white px-5 py-2 bg-color-fundo border-[1px] border-color-border ">Linkedin</a>
              <a href="mailto:joaoaugusto311016@gmail.com" className=" hover:bg-color-fundo/80 cursor-pointer rounded text-white flex gap-2 items-center px-5 py-2 bg-color-fundo border-[1px] border-color-border"> <span> <IconEmail /></span> Email</a>
            </div>
