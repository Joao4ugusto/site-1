  ...
  return(
    ...
    <section className=" w-full h-full m-5 mt-32 md:mt-24 ">
      <div className="  md:ml-56 mf:ml-[235px] lg:ml-[450px] lg:w-[600px]">
            <p className=" mb-4 text-[42px] font-bold text-white">About Me</p>
            ...
            <p className=" mb-2 mt-10 font-light text-color-font-secundaria">Hello! I m João Augusto, a Computer Science student, passionate about turning solutions into code and creating immersive and minimalist interfaces.</p>
            <p className=" mb-2 mt-5 font-light text-color-font-secundaria">At the age of 18, I founded a marketing and online ad management and website creation agency with a friend. This experience provided me with valuable learning and prepared me to fulfill my big dream of having my own business in the future.</p>
            <p className=" mb-10 mt-5 font-light text-color-font-secundaria">In my free time, music is an essential part of my life, and being with my friends and family brings joy and balance. Furthermore, the connection with nature inspires me to seek creative solutions in my journey of personal and professional growth.</p>
            <p className=" mb-10 mt-5 font-light text-color-font-secundaria">I am looking to the future and confident that I can achieve great things, leaving my mark in the digital world and positively impacting the lives of those who cross my path.</p>
