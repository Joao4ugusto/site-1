    ...
    <section className=" w-full h-full m-5 mt-32">
      <div className="">
            ...
            <ul className=" flex gap-6">
              <li className=" rounded text-color-font-principal p-2 bg-color-sidebar border-2 border-color-border">Linkedin</li>
              <li className=" rounded text-color-font-principal flex gap-2 items-center p-2 bg-color-sidebar border-2 border-color-border"> <span> <IconEmail /></span> Email</li>
            </ul>
      </div>
