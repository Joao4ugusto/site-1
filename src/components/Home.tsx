  ...
  return(
    <section className=" w-full h-full m-5 mt-32">
      <div className="">
            ...
            <p className=" mb-6 text-base font-medium text-white">I m a Brazilian software developer, born in 2002, I like to prototype interfaces, but I m not a designer haha.</p>
