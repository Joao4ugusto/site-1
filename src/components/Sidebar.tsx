...
export default function Sidebar({open, onClose, children}: props){
  return (
    <section className={`z-50 transition-all duration-500 fixed right-0  md:left-0 top-0 bottom-0 md:border-r-[1px] md:border-color-border ${open ? ' w-screen bg-black' : 'w-0'} md:w-[230px]  md:bg-color-sidebar`} >
